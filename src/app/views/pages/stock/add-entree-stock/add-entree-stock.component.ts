...
@Component({
  selector: 'kt-add-entree-stock',
  templateUrl: './add-entree-stock.component.html',
  styleUrls: ['./add-entree-stock.component.scss']
})
export class AddEntreeStockComponent implements OnInit {
