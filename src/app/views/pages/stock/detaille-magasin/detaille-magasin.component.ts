...
@Component({
  selector: 'kt-detaille-magasin',
  templateUrl: './detaille-magasin.component.html',
  styleUrls: ['./detaille-magasin.component.scss']
})
export class DetailleMagasinComponent implements OnInit {
