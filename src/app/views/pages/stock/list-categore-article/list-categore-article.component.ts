...
@Component({
  selector: 'kt-list-categore-article',
  templateUrl: './list-categore-article.component.html',
  styleUrls: ['./list-categore-article.component.scss']
})
export class ListCategoreArticleComponent implements OnInit {
...
pageCurrentChange(event :any){
  ...
  addNow(){
    this.router.navigateByUrl("/stock/ajouter-categore-article");
  } 
