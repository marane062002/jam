...
@Component({
  selector: 'kt-detaille-sortie-stock',
  templateUrl: './detaille-sortie-stock.component.html',
  styleUrls: ['./detaille-sortie-stock.component.scss']
})
export class DetailleSortieStockComponent implements OnInit {
