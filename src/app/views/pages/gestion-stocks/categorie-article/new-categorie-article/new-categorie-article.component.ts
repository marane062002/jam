...
@Component({
  selector: 'kt-new-categorie-article',
  templateUrl: './new-categorie-article.component.html',
  styleUrls: ['./new-categorie-article.component.scss']
})
export class NewCategorieArticleComponent implements OnInit {
