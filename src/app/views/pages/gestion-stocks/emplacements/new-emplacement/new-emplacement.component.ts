...
@Component({
  selector: 'kt-new-emplacement',
  templateUrl: './new-emplacement.component.html',
  styleUrls: ['./new-emplacement.component.scss']
})
export class NewEmplacementComponent implements OnInit {
