...
export class TabLoyerComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   getLoyers(id){
     ...
     this.service.getLoyersByAppartement(id)
  ...
  show(id){
    this.router.navigate(['habitation/loyer-show'] , { queryParams: { id: id, idParent : this.id } })
  }
  update(id){
    this.router.navigate(['habitation/loyer-edit'] , { queryParams: { id: id, idParent : this.id } })
  }
