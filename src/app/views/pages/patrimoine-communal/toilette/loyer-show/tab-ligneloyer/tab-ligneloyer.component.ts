...
export class TabLigneloyerComponent implements OnInit {
  ...
  getLignesLoyer(id){
     ...
     this.service.getLignesLoyerByIdLoyerToilette(id)
  ...
  show(id){
   this.router.navigate(['toilette/ligneloyer-show'] , { queryParams: { id: id } })
  }
  update(id){
    this.router.navigate(['toilette/ligneloyer-edit'] , { queryParams: { id: id } })
  }
