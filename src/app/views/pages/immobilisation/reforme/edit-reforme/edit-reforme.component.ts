...
@Component({
  selector: 'kt-edit-reforme',
  templateUrl: './edit-reforme.component.html',
  styleUrls: ['./edit-reforme.component.scss']
})
export class EditReformeComponent implements OnInit {
