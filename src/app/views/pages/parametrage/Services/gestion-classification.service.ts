...
export class GestionClassificationService {
  private baseUrl1 = environment.marcheUrl+'/Classification/';
  ...
  findById(id): Observable<any> {
	  ...
	  findByIdQualification(id): Observable<any> {
      return this.http.get<Observable<any>>(this.baseUrl1+'ClassificationByIdQualification/'+id);
      }
}