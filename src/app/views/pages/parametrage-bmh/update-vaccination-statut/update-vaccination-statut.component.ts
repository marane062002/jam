...
@Component({
  selector: 'kt-update-vaccination-statut',
  templateUrl: './update-vaccination-statut.component.html',
  styleUrls: ['./update-vaccination-statut.component.scss']
})
export class UpdateVaccinationStatutComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:VStatutService) { }
