...
@Component({
  selector: 'kt-update-arrondissement',
  templateUrl: './update-arrondissement.component.html',
  styleUrls: ['./update-arrondissement.component.scss']
})
export class UpdateArrondissementComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:ArrondissemntService) { }
