...
@Component({
  selector: 'kt-update-quantite',
  templateUrl: './update-quantite.component.html',
  styleUrls: ['./update-quantite.component.scss']
})
export class UpdateQuantiteComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:QuantiteService) { }
