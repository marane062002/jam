...
@Component({
  selector: 'kt-update-type-vaccination',
  templateUrl: './update-type-vaccination.component.html',
  styleUrls: ['./update-type-vaccination.component.scss']
})
export class UpdateTypeVaccinationComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:TypeVaccinationService) { }
