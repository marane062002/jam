...
@Component({
  selector: 'kt-update-type-traitement',
  templateUrl: './update-type-traitement.component.html',
  styleUrls: ['./update-type-traitement.component.scss']
})
export class UpdateTypeTraitementComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:TypeTraitementService) { }
