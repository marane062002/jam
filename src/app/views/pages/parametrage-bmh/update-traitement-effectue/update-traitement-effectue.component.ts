...
@Component({
  selector: 'kt-update-traitement-effectue',
  templateUrl: './update-traitement-effectue.component.html',
  styleUrls: ['./update-traitement-effectue.component.scss']
})
export class UpdateTraitementEffectueComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:TraitementEffectueService) { }
