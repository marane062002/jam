...
@Component({
  selector: 'kt-update-produit-utilise',
  templateUrl: './update-produit-utilise.component.html',
  styleUrls: ['./update-produit-utilise.component.scss']
})
export class UpdateProduitUtiliseComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:ProduitUtiliseService) { }
