...
@Component({
  selector: 'kt-update-quartier',
  templateUrl: './update-quartier.component.html',
  styleUrls: ['./update-quartier.component.scss']
})
export class UpdateQuartierComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:QuartierService) { }
