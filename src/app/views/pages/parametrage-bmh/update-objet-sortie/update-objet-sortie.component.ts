...
@Component({
  selector: 'kt-update-objet-sortie',
  templateUrl: './update-objet-sortie.component.html',
  styleUrls: ['./update-objet-sortie.component.scss']
})
export class UpdateObjetSortieComponent implements OnInit {

  constructor(private router:Router,private route:ActivatedRoute,private service:ObjetSortieService) { }
