...
import dayjs from 'dayjs/esm';
import { TypeCarburant } from '../../gestion-parc-auto/common/enumerations/type-carburant.model';
import { IAccessoireVehicule } from '../../gestion-parc-auto/common/models/accessoire-vehicule.model';
import { ICategorieVehicule } from '../../gestion-parc-auto/common/models/categorie-vehicule.model';
import { IVehicule, Vehicule, VehiculeCriteria } from '../../gestion-parc-auto/common/models/vehicule.model';
import { EtatVehicule } from '../../gestion-parc-auto/common/enumerations/etat-vehicule.model';
import { IMarque } from '../../gestion-parc-auto/common/models/marque.model';
import { DATE_TIME_FORMAT } from '../../gestion-parc-auto/common/config/input.constants';
import { StatutVehicule } from '../../gestion-parc-auto/common/enumerations/statut-vehicule.model';
...
addNow(){
  this.router.navigateByUrl("parc/add-vehicule")
}
  searchBy() {
  ...
  confirmDelete(data: any): void {
    this.vehiculeService.deleteVehicule(data).subscribe(() => {
      this.modalService.dismissAll();
      Swal.fire({
