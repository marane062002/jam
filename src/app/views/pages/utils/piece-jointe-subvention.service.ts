...
export class PieceJointeSubventionService {
	private baseUrl = environment.marcheUrl + "/PieceJointeSubvention/";
	private baseUrl1 = environment.API_ALFRESCO_URL + "/PieceJointeSubvention";
	...
	save(subvention: any) {
		return this.http.post<any>(this.baseUrl + "new", subvention, { responseType: "text" as "json" });
	}
