...
export class PieceJointeLogistiqueService {
	private baseUrl = environment.marcheUrl + "/PieceJointeLogistique/";
	private baseUrl1 = environment.API_ALFRESCO_URL + "/PieceJointeLogistique";
	...
	save(logistique: any) {
		return this.http.post<any>(this.baseUrl + "new", logistique, { responseType: "text" as "json" });
	}
