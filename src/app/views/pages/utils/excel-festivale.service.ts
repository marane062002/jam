...
export class ExcelFestivaleService {
	...
	public exportAsExcelFile(reportHeading: string, reportSubHeading: string, headersArray: any[], json: any[], footerData: any, excelFileName: string, sheetName: string) {
		...
		worksheet.getCell("F1").value = "Affaires sociales / Associations / Accompagnement et partenariat / Évènement ";
		...
		worksheet.getCell("F2").value = reportHeading;
		worksheet.getCell("F2").alignment = { vertical: "middle", horizontal: "center" };
		worksheet.getCell("F2").font = { size: 12, bold: true };
		...
		worksheet.getColumn(16).alignment = { vertical: "middle", horizontal: "center", wrapText: true };
		worksheet.addRow([]);
