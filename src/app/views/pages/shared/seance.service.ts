...
export class seanceService {
	...
	private baseUrl = environment.biencommunalUrl + "/MarcheSeanceController/";
	private baseUrl1 = environment.API_ALFRESCO_URL + "/PjSeance";

    constructor(private http: HttpClient) { }
    save(convention:any){
		return this.http.post<any[]>(this.baseUrl+"seances/new",convention, {responseType: 'text' as 'json'});
	}
