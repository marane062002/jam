...
export class AoService {
	...
	private baseUrl0 = environment.marcheUrl;
	...
	*/
	...
	convocationCommissionAoGenerator(path, idAo, participant, type) {
		const httpOptions = {
			responseType: "arraybuffer" as "json",
		};
		// return this.http.get<any[]>(this.baseUrl6 + path + idAo + "/" + participant + "/"+ etape, httpOptions);
		return this.http.get<any[]>(this.baseUrl6 + path + idAo + "/" + participant + "/" + type, httpOptions);
	}
	...
	// get commision by etatRole
	getRoleCommissionByEtatRole(etatRole): Observable<any> {
		return this.http.get<Observable<any>>(
			this.baseUrl + "RoleCommissionByEtatRole/" + etatRole
		);
	}
	...
	async getPIbyEtatMembre(etat, id) {

		return await this.http.get<any>(this.baseUrl + "ParticipantInterneByEtatMembre/" + etat + "/" + id)
			.pipe(delay(300))
			.toPromise();
	}
	getPIbyEtatMembrePagination(etat, id, page, size) {
		return this.http.get<any[]>(this.baseUrl + "ParticipantInterneByEtatMembre/" + etat + "/" + id + "?page=" + page + "&size=" + size);
	}
	async getPEbyEtatMembre(etat, id) {
		return this.http
			.get<any>(this.baseUrl + "ParticipantExterneeByEtatMembre/" + etat + "/" + id)
			.toPromise();
	}
	getPEbyEtatMembrePagination(etat, id, page, size) {
		return this.http.get<any[]>(this.baseUrl + "ParticipantExterneeByEtatMembre/" + etat + "/" + id + "?page=" + page + "&size=" + size);
	}
	...
	getAllLigneBPByPage(id, page, size) {
		return this.http.get<any[]>(this.baseUrl + "LigneByBP/" + id + "?page=" + page + "&size=" + size);
	}
	...
	getAllOffreDeposee(id, page, size): Observable<any> {
		return this.http.get<Observable<any>>(
			this.baseUrl + "AllOffreDeposee/" + id + "?page=" + page + "&size=" + size
		);
	}


	getAllOffreDeposeeWithoutPagination(id): Observable<any> {
		return this.http.get<Observable<any>>(
			this.baseUrl + "AllOffreDeposee-withoout-pagination/" + id
		);
	}
	...
	findByTypeCommission_IdAndAo_Id(idType, idAo): Observable<any> {
		return this.http.get<Observable<any>>(
			this.baseUrl + "findByTypeCommission_IdAndAo_Id/" + idType + '/' + idAo
		);
	}
	...
	//COMPARAISON ENDPOINTS (prix entre prestataire et bordereau)

	sendPrixPrestataire(f): Observable<any> {
		return this.http.post<Observable<any>>(
			this.baseUrl0 + "/compare-prix/",
			f
		);
	}
	GetPrixPrestataire(id, idp): Observable<any> {
		return this.http.get<Observable<any>>(
			this.baseUrl0 + `/compare-prix/prestataire/${id}/${idp}`
		);
	}

	DeletePrixPrestataire(id, idp): Observable<any> {
		return this.http.delete<Observable<any>>(
			this.baseUrl0 + `/compare-prix/${id}/${idp}`
		);
	}
	...
	editProgrammePrevisionnel(f): Observable<any> {

		return this.http.put<Observable<any>>(
			this.baseUrl8 + "Update", f
		);
	}
	...
	findByIdPresident(id) {
		let path = this.baseUrl8 + 'findByIdPresident/' + id
	...
	deleteProgrammePrevisionnel(id) {
		let path = this.baseUrl8 + 'delete/' + id


		return this.http.delete<any>(path);
	}
	PaginationProgrammePrevisionnel(page, size) {
		return this.http.get<any[]>(this.baseUrl8 + "findAll?page=" + page + "&size=" + size);
	}
	PaginationProgrammePrevisionnelByIdPresident(id, page, size) {
		return this.http.get<any[]>(this.baseUrl8 + "findByIdPresident/" + id + "?page=" + page + "&size=" + size);
	}
