...
@Component({
  selector: 'kt-participants-internes-commission-technique-ao-detail',
  templateUrl: './participants-internes-commission-technique-ao-detail.component.html',
  styleUrls: ['./participants-internes-commission-technique-ao-detail.component.scss']
})
export class ParticipantsInternesCommissionTechniqueAoDetailComponent implements OnInit {
  // =================================================================
  //
  // =================================================================
  TypeCommission  = 0;
  ...
  getParticipants() {
    ...
    this.PI = [];
    this.service.getPIbyEtatMembre('MEMBRE_TECHNIQUE',this.idao).then(data => {
...
convocation(idCommission,nomComplet) {
  ...
  this.service.getPIbyEtatMembre('MEMBRE_TECHNIQUE',idCommission).then(data => {
