...
@Component({
  selector: 'kt-modal-show-calendrier-ao',
  templateUrl: './modal-show-calendrier-ao.component.html',
  styleUrls: ['./modal-show-calendrier-ao.component.scss']
})
export class ModalShowCalendrierAoComponent implements OnInit {
  ...
  language: string = localStorage.getItem("language") || 'ar';
	...
	constructor(private router: Router,
		...
		public dialogRef: MatDialogRef<ModalShowCalendrierAoComponent>,
    ...
    this.serviceao.findAoByDateOuverturePlisOrderByIdDesc(this.dateDayNow).then((res)=>{
  ...
  this.dialogRef.close();
	...
	onNoClick(): void {
		this.router.navigate(["/marches/calendrier"]);
