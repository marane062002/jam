...
@Component({
	selector: "kt-ligne-bordereau-prix-form",
	templateUrl: "./ligne-bordereau-prix-form.component.html",
	styleUrls: ["./ligne-bordereau-prix-form.component.scss"],
})
export class LigneBordereauPrixFormComponent implements OnInit {
	// ===========================================================================
	//
	// ===========================================================================
	dataShow:any; 
