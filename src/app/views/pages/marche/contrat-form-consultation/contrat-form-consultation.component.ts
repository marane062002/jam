...
@Component({
	selector: "kt-contrat-form-consultation",
	templateUrl: "./contrat-form-consultation.component.html",
	styleUrls: ["./contrat-form-consultation.component.scss"],
})
export class ContratFormConsultationComponent implements OnInit {
	displayedColumns = [
		"nom",
		"tel",
		"mail",
