...
@Component({
  selector: 'kt-status-logistic-dialog',
  templateUrl: './status-logistic-dialog.component.html',
  styleUrls: ['./status-logistic-dialog.component.scss']
})
export class StatusLogisticDialogComponent implements OnInit {
  ...
  changeStatus(newStatus: string): void {
    ...
    this.demandeService.changeStatusLogistic(data).subscribe(
      (response) => {
