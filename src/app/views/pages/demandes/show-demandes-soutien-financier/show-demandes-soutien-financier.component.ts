...
@Component({
  selector: 'kt-show-demandes-soutien-financier',
  templateUrl: './show-demandes-soutien-financier.component.html',
  styleUrls: ['./show-demandes-soutien-financier.component.scss']
})
export class ShowDemandesSoutienFinancierComponent implements OnInit {
  // ============================================
  demandeDetails: any;
  ...
  // =====================================
  back() {
    this.router.navigate(["/demandes/list-demandes-soutien-financiere"]);
  }
