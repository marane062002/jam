...
import { DialogData, StatusChangeDialogComponent } from '../status-change-dialog/status-change-dialog.component';
@Component({
  selector: 'kt-status-financier-dialog',
  templateUrl: './status-financier-dialog.component.html',
  styleUrls: ['./status-financier-dialog.component.scss']
})
export class StatusFinancierDialogComponent implements OnInit {
  ...
  changeStatus(newStatus: string): void {
    ...
    this.demandeService.changeStatutFinancier(data).subscribe(
      (response) => {
