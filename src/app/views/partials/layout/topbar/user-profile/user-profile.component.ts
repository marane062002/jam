...
import { OrganisationService } from '../../../../../views/pages/organisation/organisation.service';
...
export class UserProfileComponent implements OnInit {
	...
	*/
	...
	courrierShow(idPers, idDiv) {
		...
		window.localStorage.setItem("idPers",idPers.toString());
		window.localStorage.setItem("idDiv",idDiv.toString());
	 ...
	 */
	communication() {
		window.open('http://marrakech.jamaati.ma:3000/channel/general', '_blank');
	}
	/**
	 * Log out
	 */
